...
SONG_DOWNLOAD_DURATION = int(
    getenv("SONG_DOWNLOAD_DURATION_LIMIT", "99999")
)  # Remember to give value in Minutes
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1971311438").split())
...
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/lucyprojectteam"
...
SPOTIFY_CLIENT_ID = getenv("SPOTIFY_CLIENT_ID", "95ae0799a00947a8b0cfb1ed39934252")
SPOTIFY_CLIENT_SECRET = getenv("SPOTIFY_CLIENT_SECRET", "04c0c0b28a8f4fcbbe53e082d3258c05")
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "9999999999999")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "9999999999999")
)  # Remember to give value in bytes
